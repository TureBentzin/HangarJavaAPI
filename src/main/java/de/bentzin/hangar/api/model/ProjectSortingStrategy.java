 ...
 */
@JsonAdapter(ProjectSortingStrategy.Adapter.class)
public enum ProjectSortingStrategy {
  ...
  public static ProjectSortingStrategy fromValue(String value) {
  ...
  public static class Adapter extends TypeAdapter<ProjectSortingStrategy> {
    @Override
    public void write(final JsonWriter jsonWriter, final ProjectSortingStrategy enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ProjectSortingStrategy read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ProjectSortingStrategy.fromValue(value);
    }
  }
}
