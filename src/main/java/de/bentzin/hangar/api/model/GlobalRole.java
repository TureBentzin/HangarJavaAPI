 ...
 */
@JsonAdapter(GlobalRole.Adapter.class)
public enum GlobalRole {

  HANGAR_ADMIN("HANGAR_ADMIN", 1),

  HANGAR_DEV("HANGAR_DEV", 2),

  HANGAR_MOD("HANGAR_MOD", 3),

  PAPERMC_CORE("PAPERMC_CORE", 4),

  PAPERMC_STAFF("PAPERMC_STAFF", 5),
  ...
  GlobalRole(String value, int id) {
    this.value = value;
  }
  ...
  public static GlobalRole fromValue(String value) {
    for (GlobalRole b : GlobalRole.values()) {
      if (String.valueOf(b.id).equals(value)) {
        return b;
      }
    }
  ...
  public static class Adapter extends TypeAdapter<GlobalRole> {
    @Override
    public void write(final JsonWriter jsonWriter, final GlobalRole enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public GlobalRole read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return GlobalRole.fromValue(value);
    }
  }
}