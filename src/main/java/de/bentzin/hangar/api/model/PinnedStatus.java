...
/**
 * Gets or Sets PinnedStatus
 */
@JsonAdapter(PinnedStatus.Adapter.class)
public enum PinnedStatus {
  ...
  public static PinnedStatus fromValue(String value) {
    for (PinnedStatus b : PinnedStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<PinnedStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final PinnedStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public PinnedStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return PinnedStatus.fromValue(value);
    }
  }
}
