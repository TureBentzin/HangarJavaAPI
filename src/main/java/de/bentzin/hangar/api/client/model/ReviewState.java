 ...
 */
@JsonAdapter(ReviewState.Adapter.class)
public enum ReviewState {
  ...
  public static class Adapter extends TypeAdapter<ReviewState> {
    @Override
    public void write(final JsonWriter jsonWriter, final ReviewState enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ReviewState read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ReviewState.fromValue(value);
    }
  }
}
