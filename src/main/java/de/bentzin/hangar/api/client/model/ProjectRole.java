 ...
 */
@JsonAdapter(ProjectRole.Adapter.class)
public enum ProjectRole {
  ...
  public static class Adapter extends TypeAdapter<ProjectRole> {
    @Override
    public void write(final JsonWriter jsonWriter, final ProjectRole enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ProjectRole read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ProjectRole.fromValue(value);
    }
  }
}
