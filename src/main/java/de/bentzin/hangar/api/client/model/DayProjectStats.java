...
public class DayProjectStats {
  ...
  public DayProjectStats views(Long views) {
  ...
  **/
  ...
  public DayProjectStats downloads(Long downloads) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DayProjectStats dayProjectStats = (DayProjectStats) o;
    return Objects.equals(this.views, dayProjectStats.views) &&
        Objects.equals(this.downloads, dayProjectStats.downloads);
  }

  @Override
  public int hashCode() {
    return Objects.hash(views, downloads);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DayProjectStats {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to DayProjectStats
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DayProjectStats.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DayProjectStats is not found in the empty JSON string", DayProjectStats.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!DayProjectStats.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DayProjectStats` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DayProjectStats.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DayProjectStats' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DayProjectStats> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DayProjectStats.class));

       return (TypeAdapter<T>) new TypeAdapter<DayProjectStats>() {
           @Override
           public void write(JsonWriter out, DayProjectStats value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DayProjectStats read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of DayProjectStats given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DayProjectStats
  * @throws IOException if the JSON string is invalid with respect to DayProjectStats
  */
  public static DayProjectStats fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DayProjectStats.class);
  }

 /**
  * Convert an instance of DayProjectStats to an JSON string
  *
  * @return JSON string
  */
