...
public class PaginatedResultProjectCompact {
  ...
  private List<ProjectCompact> result = null;

  public PaginatedResultProjectCompact() {
  }

  public PaginatedResultProjectCompact pagination(Pagination pagination) {
  ...
  **/
  ...
  public PaginatedResultProjectCompact result(List<ProjectCompact> result) {
    
    this.result = result;
    return this;
  }

  public PaginatedResultProjectCompact addResultItem(ProjectCompact resultItem) {
    if (this.result == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PaginatedResultProjectCompact paginatedResultProjectCompact = (PaginatedResultProjectCompact) o;
    return Objects.equals(this.pagination, paginatedResultProjectCompact.pagination) &&
        Objects.equals(this.result, paginatedResultProjectCompact.result);
  }
  ...
  public String toString() {
    ...
    sb.append("class PaginatedResultProjectCompact {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PaginatedResultProjectCompact
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PaginatedResultProjectCompact.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PaginatedResultProjectCompact is not found in the empty JSON string", PaginatedResultProjectCompact.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PaginatedResultProjectCompact.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PaginatedResultProjectCompact` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      if (jsonObj.get("result") != null && !jsonObj.get("result").isJsonNull()) {
        ...
        if (jsonArrayresult != null) {
          ...
          for (int i = 0; i < jsonArrayresult.size(); i++) {
            ProjectCompact.validateJsonObject(jsonArrayresult.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PaginatedResultProjectCompact.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PaginatedResultProjectCompact' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PaginatedResultProjectCompact> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PaginatedResultProjectCompact.class));

       return (TypeAdapter<T>) new TypeAdapter<PaginatedResultProjectCompact>() {
           @Override
           public void write(JsonWriter out, PaginatedResultProjectCompact value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PaginatedResultProjectCompact read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of PaginatedResultProjectCompact given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PaginatedResultProjectCompact
  * @throws IOException if the JSON string is invalid with respect to PaginatedResultProjectCompact
  */
  public static PaginatedResultProjectCompact fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PaginatedResultProjectCompact.class);
  }

 /**
  * Convert an instance of PaginatedResultProjectCompact to an JSON string
  *
  * @return JSON string
  */
