...
public class PaginatedResultProject {
  ...
  public PaginatedResultProject() {
  }

  public PaginatedResultProject pagination(Pagination pagination) {
  ...
  **/
  ...
  public PaginatedResultProject result(List<Project> result) {
    
    this.result = result;
    return this;
  }

  public PaginatedResultProject addResultItem(Project resultItem) {
    if (this.result == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PaginatedResultProject paginatedResultProject = (PaginatedResultProject) o;
    return Objects.equals(this.pagination, paginatedResultProject.pagination) &&
        Objects.equals(this.result, paginatedResultProject.result);
  }
  ...
  public String toString() {
    ...
    sb.append("class PaginatedResultProject {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PaginatedResultProject
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PaginatedResultProject.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PaginatedResultProject is not found in the empty JSON string", PaginatedResultProject.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PaginatedResultProject.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PaginatedResultProject` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      if (jsonObj.get("result") != null && !jsonObj.get("result").isJsonNull()) {
        ...
        if (jsonArrayresult != null) {
          ...
          for (int i = 0; i < jsonArrayresult.size(); i++) {
            Project.validateJsonObject(jsonArrayresult.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PaginatedResultProject.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PaginatedResultProject' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PaginatedResultProject> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PaginatedResultProject.class));

       return (TypeAdapter<T>) new TypeAdapter<PaginatedResultProject>() {
           @Override
           public void write(JsonWriter out, PaginatedResultProject value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PaginatedResultProject read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of PaginatedResultProject given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PaginatedResultProject
  * @throws IOException if the JSON string is invalid with respect to PaginatedResultProject
  */
  public static PaginatedResultProject fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PaginatedResultProject.class);
  }

 /**
  * Convert an instance of PaginatedResultProject to an JSON string
  *
  * @return JSON string
  */
