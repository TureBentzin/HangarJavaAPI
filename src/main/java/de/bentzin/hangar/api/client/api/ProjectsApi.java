...
public class ProjectsApi {
    ...
    private okhttp3.Call getProjectValidateBeforeCall(String author, String slug, final ApiCallback _callback) throws ApiException {
        ...
        return getProjectCall(author, slug, _callback);
    ...
    private okhttp3.Call getProjectMembersValidateBeforeCall(String author, String slug, RequestPagination pagination, final ApiCallback _callback) throws ApiException {
        ...
        return getProjectMembersCall(author, slug, pagination, _callback);
    ...
    private okhttp3.Call getProjectStargazersValidateBeforeCall(String author, String slug, RequestPagination pagination, final ApiCallback _callback) throws ApiException {
        ...
        return getProjectStargazersCall(author, slug, pagination, _callback);
    ...
    private okhttp3.Call getProjectWatchersValidateBeforeCall(String author, String slug, RequestPagination pagination, final ApiCallback _callback) throws ApiException {
        ...
        return getProjectWatchersCall(author, slug, pagination, _callback);
     ...
     * @param q2 The query to use when searching (optional)
     ...
     */
    public okhttp3.Call getProjectsCall(RequestPagination pagination, String q, Boolean orderWithRelevance, String sort, String category, String platform, String owner, String q2, String license, String version, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        if (q2 != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("q", q2));
        }
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getProjectsValidateBeforeCall(RequestPagination pagination, String q, Boolean orderWithRelevance, String sort, String category, String platform, String owner, String q2, String license, String version, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'pagination' is set
        if (pagination == null) {
            throw new ApiException("Missing the required parameter 'pagination' when calling getProjects(Async)");
        }

        return getProjectsCall(pagination, q, orderWithRelevance, sort, category, platform, owner, q2, license, version, _callback);
     ...
     */
    public PaginatedResultProject getProjects(RequestPagination pagination, String q, Boolean orderWithRelevance, String sort, String category, String platform, String owner, String q2, String license, String version) throws ApiException {
        ApiResponse<PaginatedResultProject> localVarResp = getProjectsWithHttpInfo(pagination, q, orderWithRelevance, sort, category, platform, owner, q2, license, version);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<PaginatedResultProject> getProjectsWithHttpInfo(RequestPagination pagination, String q, Boolean orderWithRelevance, String sort, String category, String platform, String owner, String q2, String license, String version) throws ApiException {
        okhttp3.Call localVarCall = getProjectsValidateBeforeCall(pagination, q, orderWithRelevance, sort, category, platform, owner, q2, license, version, null);
     ...
     */
    public okhttp3.Call getProjectsAsync(RequestPagination pagination, String q, Boolean orderWithRelevance, String sort, String category, String platform, String owner, String q2, String license, String version, final ApiCallback<PaginatedResultProject> _callback) throws ApiException {

        okhttp3.Call localVarCall = getProjectsValidateBeforeCall(pagination, q, orderWithRelevance, sort, category, platform, owner, q2, license, version, _callback);
        Type localVarReturnType = new TypeToken<PaginatedResultProject>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    private okhttp3.Call showProjectStatsValidateBeforeCall(String author, String slug, OffsetDateTime fromDate, OffsetDateTime toDate, final ApiCallback _callback) throws ApiException {
        ...
        return showProjectStatsCall(author, slug, fromDate, toDate, _callback);
