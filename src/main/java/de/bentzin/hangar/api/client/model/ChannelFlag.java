...
/**
 * Gets or Sets ChannelFlag
 */
@JsonAdapter(ChannelFlag.Adapter.class)
public enum ChannelFlag {
  ...
  public static ChannelFlag fromValue(String value) {
    for (ChannelFlag b : ChannelFlag.values()) {
  ...
  public static class Adapter extends TypeAdapter<ChannelFlag> {
    @Override
    public void write(final JsonWriter jsonWriter, final ChannelFlag enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ChannelFlag read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ChannelFlag.fromValue(value);
    }
  }
}
