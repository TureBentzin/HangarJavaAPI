  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ProjectSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProjectSettings` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      if (jsonObj.get("license") != null && !jsonObj.get("license").isJsonNull()) {
        ProjectLicense.validateJsonObject(jsonObj.getAsJsonObject("license"));
      }
      // validate the optional field `donation`
      if (jsonObj.get("donation") != null && !jsonObj.get("donation").isJsonNull()) {
        ProjectDonationSettings.validateJsonObject(jsonObj.getAsJsonObject("donation"));
      }
