...
public class PermissionCheck {
  ...
  * @throws IOException if the JSON Object is invalid with respect to PermissionCheck
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PermissionCheck.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PermissionCheck is not found in the empty JSON string", PermissionCheck.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PermissionCheck.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PermissionCheck` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PermissionCheck.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PermissionCheck' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PermissionCheck> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PermissionCheck.class));

       return (TypeAdapter<T>) new TypeAdapter<PermissionCheck>() {
           @Override
           public void write(JsonWriter out, PermissionCheck value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PermissionCheck read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of PermissionCheck given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PermissionCheck
  * @throws IOException if the JSON string is invalid with respect to PermissionCheck
  */
  public static PermissionCheck fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PermissionCheck.class);
  }

 /**
  * Convert an instance of PermissionCheck to an JSON string
  *
  * @return JSON string
  */
