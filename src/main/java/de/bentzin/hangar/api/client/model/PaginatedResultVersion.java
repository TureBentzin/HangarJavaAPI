...
public class PaginatedResultVersion {
  ...
  * @throws IOException if the JSON Object is invalid with respect to PaginatedResultVersion
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PaginatedResultVersion.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PaginatedResultVersion is not found in the empty JSON string", PaginatedResultVersion.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PaginatedResultVersion.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PaginatedResultVersion` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      if (jsonObj.get("result") != null && !jsonObj.get("result").isJsonNull()) {
        ...
        if (jsonArrayresult != null) {
          ...
          for (int i = 0; i < jsonArrayresult.size(); i++) {
            Version.validateJsonObject(jsonArrayresult.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PaginatedResultVersion.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PaginatedResultVersion' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PaginatedResultVersion> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PaginatedResultVersion.class));

       return (TypeAdapter<T>) new TypeAdapter<PaginatedResultVersion>() {
           @Override
           public void write(JsonWriter out, PaginatedResultVersion value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PaginatedResultVersion read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of PaginatedResultVersion given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PaginatedResultVersion
  * @throws IOException if the JSON string is invalid with respect to PaginatedResultVersion
  */
  public static PaginatedResultVersion fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PaginatedResultVersion.class);
  }

 /**
  * Convert an instance of PaginatedResultVersion to an JSON string
  *
  * @return JSON string
  */
