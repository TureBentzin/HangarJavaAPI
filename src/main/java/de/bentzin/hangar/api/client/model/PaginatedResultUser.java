...
public class PaginatedResultUser {
  ...
  public PaginatedResultUser() {
  }

  public PaginatedResultUser pagination(Pagination pagination) {
  ...
  **/
  ...
  public PaginatedResultUser result(List<User> result) {
    
    this.result = result;
    return this;
  }

  public PaginatedResultUser addResultItem(User resultItem) {
    if (this.result == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PaginatedResultUser paginatedResultUser = (PaginatedResultUser) o;
    return Objects.equals(this.pagination, paginatedResultUser.pagination) &&
        Objects.equals(this.result, paginatedResultUser.result);
  }
  ...
  public String toString() {
    ...
    sb.append("class PaginatedResultUser {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PaginatedResultUser
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PaginatedResultUser.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PaginatedResultUser is not found in the empty JSON string", PaginatedResultUser.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PaginatedResultUser.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PaginatedResultUser` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      if (jsonObj.get("result") != null && !jsonObj.get("result").isJsonNull()) {
        ...
        if (jsonArrayresult != null) {
          ...
          for (int i = 0; i < jsonArrayresult.size(); i++) {
            User.validateJsonObject(jsonArrayresult.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PaginatedResultUser.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PaginatedResultUser' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PaginatedResultUser> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PaginatedResultUser.class));

       return (TypeAdapter<T>) new TypeAdapter<PaginatedResultUser>() {
           @Override
           public void write(JsonWriter out, PaginatedResultUser value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PaginatedResultUser read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of PaginatedResultUser given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PaginatedResultUser
  * @throws IOException if the JSON string is invalid with respect to PaginatedResultUser
  */
  public static PaginatedResultUser fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PaginatedResultUser.class);
  }

 /**
  * Convert an instance of PaginatedResultUser to an JSON string
  *
  * @return JSON string
  */
