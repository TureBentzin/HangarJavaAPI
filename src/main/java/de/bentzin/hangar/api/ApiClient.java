...
import de.bentzin.hangar.api.auth.ApiKeyAuth;
import de.bentzin.hangar.api.auth.Authentication;
import de.bentzin.hangar.api.auth.HttpBasicAuth;
import de.bentzin.hangar.api.auth.HttpBearerAuth;
...
public class ApiClient {
    ...
    public List<Pair> parameterToPair(String name, Object value) {
        ...
        //Fix pagination's by TureBentzin
        if (value instanceof RequestPagination pagination) {
            if (pagination.getLimit() != null) {
                params.add(new Pair("limit", pagination.getLimit().toString()));
            }
            if (pagination.getOffset() != null) {
                params.add(new Pair("offset", pagination.getOffset().toString()));
            }
        }


        //END Fix pagination's
